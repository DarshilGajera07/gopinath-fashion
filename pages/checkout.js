...
const Checkout = ({cart,subtotal,addtocart,removefromcart}) => {
  return (
    <div className='container px-2 sm:m-auto'>
      ...
      <div className='mx-4'>
      <Link href={'/checkout'}>
         <button className="flex mr-2 text-white bg-pink-500 border-0 py-2 px-2 focus:outline-none hover:bg-indigo-600 rounded text-sm"><BsFillBagCheckFill className='m-1' />Pay ₹ {subtotal}</button>
         </Link>
      </div>
