...
const Post = ({addtocart}) => {
  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px object-cover object-top rounded" src="https://m.media-amazon.com/images/I/713n+TxyfCL._SY879_.jpg"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">Gopinath Fashion</h2>
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Wear the cloth(Blue)</h1>
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900">₹450.00</span>
          ...
          <button onClick={()=>{addtocart(slug,1,450,'tshirts','xl','blue')}} className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
        ...
        <div className='pin mt-6 flex space-x-2 text-sm'>
          <input onChange={onChangepin} className='px-2 border-2 rounded-md' placeholder='Enter Your Pincode' type='text'/>
